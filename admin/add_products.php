...
<?php endif ?>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name='list_price' placeholder="Add Price">
    </div>
  </div>
  <div class="form-group row">
    <label for="inputEmail3" class="col-sm-2 col-form-label">Discount Percent</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name='discount_percent' placeholder="Add Discount">
    </div>
  </div>
  <div class="form-group row">
    <label for="inputEmail3" class="col-sm-2 col-form-label">Date</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name='date_added' placeholder="Add Date">
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name='category_id' placeholder="Add Category Code">
    </div>
    <div class="form-group row">
    <div class="col-sm-10">
